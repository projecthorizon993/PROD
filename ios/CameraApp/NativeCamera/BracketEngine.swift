...
final class BracketEngine {
    ...
    func bracketSettings(for device: AVCaptureDevice, baseISO: Float, baseDuration: CMTime) -> AVCapturePhotoBracketSettings? {
        ...
        guard let bracket = try? AVCapturePhotoBracketSettings(rawFormat: nil, processedFormat: [AVVideoCodecKey: AVVideoCodecType.hevc], bracketedSettings: settings) else { return nil }
